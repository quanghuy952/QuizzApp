...
class MainActivity : AppCompatActivity() {
    ...
    private fun questionList():MutableList<QuestionModel>{
        ...
        question.add(QuestionModel(
            2,
            "Which country is the largest in the worlds by land area",
            "Russia",
            "Canada",
            "United States",
            "China" ,
        ...
        question.add(QuestionModel(
            5,
            "Which of the following symbols represents the chemical element which the atomic number 6?",
            "O",
            "H",
            "N",
            "C" ,
        ...
        question.add(QuestionModel(
            6,
            "Who is created with the inventing theater as we know it today?",
            "Shakespeare",
            "Arthur Miller",
            "Ancient Greeks",
            "Ashkouri" ,
